...
const (
	...
	qInsertTempApplication  = `INSERT INTO temp_applications (temp_application_id, email, phone_number, projects, application_text, created_at) VALUES (:temp_application_id, :email, :phone_number, :projects, :application_text, :created_at)`
